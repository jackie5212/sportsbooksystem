...
('wechat_web_appid', '', '网页端微信支付-公众号/服务号 AppID'),
('wechat_web_appsecret', '', '网页端微信支付-公众号 AppSecret'),
('wechat_mini_appid', '', '小程序微信支付-小程序 AppID'),
('wechat_mini_appsecret', '', '小程序微信支付-小程序 AppSecret'),
